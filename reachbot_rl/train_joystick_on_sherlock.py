...
def trainModel(ppo_params_input:dict = None):
  ...
  env_cfg.reward_config.scales.feet_height=-1 #Default is -
  ...
  #env_cfg.reward_config.scales.energy=-0.001,                # Penalty scale for orientation. Default is -0.1
  ...
  writer = SummaryWriter(logdir='runlogs_joystick/'+new_folder_path)
...
if __name__ == '__main__':
  ...
  for i in range(1):
    # Modify params for faster training
    ppo_training_params["num_timesteps"] = 30_000_000 # Reduce from 60000000
