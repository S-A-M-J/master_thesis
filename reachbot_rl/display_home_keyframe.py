...
import mujoco
import numpy as np
from reachbot.reachbot_constants import BASIC_FLAT_TERRAIN_XML, DEFLECTION_FLAT_TERRAIN_XML, task_to_xml
...
xml_path = task_to_xml("flat_terrain_deflection").as_posix()
