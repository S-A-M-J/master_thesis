...
class Getup(reachbot_base.ReachbotEnv):
  ...
  def __init__(
     ...
     template_path = os.path.join(os.path.dirname(__file__), "environment/getup_scene_template.xml")
     with open(template_path, "r") as f:
        scene_template = f.read()
     scene_xml = scene_template.replace("{REACHBOT_MODEL_PATH}", self.reachbot_model.model_path)
     xml_file = os.path.join(os.path.dirname(__file__), "environment/getup_scene.xml")
