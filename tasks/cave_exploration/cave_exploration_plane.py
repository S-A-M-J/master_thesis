...
class CaveExplore(reachbot_base.ReachbotEnv):
  ...
  def __init__(
    ...
    super().__init__(scene_xml_path, config, config_overrides)
  ...
  def _post_init(self) -> None:
    ...
    self._cave_geom_ids = np.array([
      ...
      if mujoco.mj_id2name(self._mj_model, mujoco.mjtObj.mjOBJ_GEOM, i).startswith("cave_wall_box")
    ])
    ...
    for i in range(self._mj_model.ngeom):
        geom_name = mujoco.mj_id2name(self._mj_model, mujoco.mjtObj.mjOBJ_GEOM, i)
