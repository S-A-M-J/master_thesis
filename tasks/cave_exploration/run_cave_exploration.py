...
def trainModel(ppo_params_input:dict = None, on_sherlock:bool = False):
    ...
    env_cfg.reward_config.scales.termination = -0.0
    env_cfg.reward_config.scales.inactivity = -0.1#0.1

    # Target-based rewards
    env_cfg.reward_config.scales.distance_to_target = 0.0#5.0
    env_cfg.reward_config.scales.vel_to_target = 10.0
...
if __name__ == '__main__':
    ...
    # Modify params for faster training
    ppo_training_params["num_timesteps"] = 60_000_000
    ...
    ppo_training_params["unroll_length"] = 128
    ppo_training_params["entropy_cost"] = 0.2
