...
os.environ['XLA_PYTHON_CLIENT_MEM_FRACTION'] = '0.92'  # Use 98.5% of GPU memory (~39.4GB out of 40GB)
...
def configure_environment_from_config(loaded_config):
    ...
    env_cfg.reward_config.scales.torques = -0.0001  # Small torque penalty to encourage efficiency
    env_cfg.reward_config.scales.action_rate = -0.01  # Small action rate penalty to encourage smoothness
    env_cfg.reward_config.scales.energy = -0.001  # Small energy penalty to encourage efficiency
